...
class CuraConan(ConanFile):
    ...
    def generate(self):
        ...
        if self.settings.os == "Windows":
            ext = ".exe"
        curaengine_src = pathlib.Path(os.path.join(self.deps_cpp_info["curaengine"].rootpath, "bin", f"CuraEngine{ext}"))
        ...
        tc.variables["URANIUM_DIR"] = os.path.join(self.deps_cpp_info["uranium"].rootpath, "")
        tc.generate()
